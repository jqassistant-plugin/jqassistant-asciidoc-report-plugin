...
import org.jqassistant.plugin.asciidocreport.AsciidoctorFactory;
...
class ExecutablesTest extends AbstractRuleParserTest {

    @Test
    void asciidoc() throws Exception {
        RuleSet ruleSet = readRuleSet("/parser/executables.adoc");
    ...
    void plantuml() throws Exception {
        ...
        StructuralNode abstractBlock = (StructuralNode) concept.getExecutable()
            .getSource();
        String imagesDirectoryAttribute = (String) abstractBlock.getDocument()
            .getAttributes()
            .get(AsciidoctorFactory.ATTRIBUTE_IMAGES_OUT_DIR);
        ...
        String fileName = (String) abstractBlock.getAttributes()
            .get("target");
